...
public class RegisterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.app.raceanalyzer.R.layout.activity_register);

        mUsernameField = (EditText) findViewById(com.app.raceanalyzer.R.id.register_username);
        mPasswordField = (EditText) findViewById(com.app.raceanalyzer.R.id.register_password);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.app.raceanalyzer.R.menu.register, menu);
        return true;
    }
